...
public class CheckStock {
    ...
    private void createStock() {
        stock.add(new Stock("Pannacotta", 3, "In house", 1112));
        stock.add(new Stock("Thai basil", 5, "Allotment", 1115));
        }

    private void checkPantry() {
    ...
    private void amendStockChoice(int choice) {
    ...
    private void getStockEdit(Stock s, int i) {
        switch (i) {
            case 1 :
